...
*/
$config['tables']['users']           = 'afric_aventure_users';
$config['tables']['groups']          = 'afric_aventure_groups';
$config['tables']['users_groups']    = 'afric_aventure_users_groups';
$config['tables']['login_attempts']  = 'afric_aventure_login_attempts';
